...
const products = [
    {
        ...
        price: 12.00,
        image_url: JSON.stringify([{ url: "https://thegreenvalleybot-production.up.railway.app/public/img/og_kush.png", type: "photo" }]),
        category: "Fleurs",
        is_active: true,
        unit: "g",
        unit_value: "1",
    ...
    },
    {
        ...
        price: 15.00,
        image_url: JSON.stringify([{ url: "https://thegreenvalleybot-production.up.railway.app/public/img/double_zero.png", type: "photo" }]),
        category: "Resines",
        is_active: true,
        unit: "g",
        unit_value: "1",
    ...
    },
    {
        ...
        price: 45.00,
        image_url: JSON.stringify([{ url: "https://thegreenvalleybot-production.up.railway.app/public/img/cbd_oil.png", type: "photo" }]),
        category: "Huiles",
        is_active: true,
        unit: "flacon",
        unit_value: "1",
...
async function run() {
    ...
    const settingsPayload = {
        ...
        dashboard_title: 'Thegreenvalley Bot',
